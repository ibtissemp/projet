...
function Uniter4() {
  return (
   ...
   <h1> Rpport d' analyse de l' Unite 7600</h1> 
 <ul> <li>Phosphate consomme:  (Wk)</li> </ul>
...
<Table  border={2}>
      ...
      <ul> <li>Phosphogypse collecteur</li> </ul>
